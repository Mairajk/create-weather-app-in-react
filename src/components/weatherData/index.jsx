...
let Weather = () => {
    ...
    let getWeather = (e) => {
        e.preventDefault();
        axios.get(`https://api.weatherapi.com/v1/current.json?key=1148694ef40c4addba8201236223006&q=${cityName}`)
        ...
        <div>
            ...
            {(weatherData === null) ? null :
                ...
                <div id="weatherReport" className="hidden">
                    ...
                    <div id="iconDiv">
                        <div id="icon"> <img src="" alt="" id="wIcon" /></div>
                        <div id="temp"><h2> {weatherData.current.temp_c} &deg;C   </h2></div>
                    </div>

                    <div id="weatherType"><h2> {weatherData.current.condition.text} </h2></div>

                    <div id="name">
                        <div id="cityName" className="name"> <h2> {weatherData.location.name}  </h2>  </div>
                        <div id="countryName" className="name"><h3> {weatherData.location.country} .  </h3></div>
                    </div>
